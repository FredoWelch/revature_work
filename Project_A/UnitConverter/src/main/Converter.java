...
public class Converter {
	   ...
	   private static double cupsToTeaspoons(double cups) {
	      
	       return (cups * 48);
	   }
	  
	   private static double uSGallonsToImperialGallons(double gallons) {
